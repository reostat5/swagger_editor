      ...
      <div className="swagger-editor-standalone">
        <div className="topbar">
          <div className="topbar-wrapper">
            <Link href="https://www.sap.com/index.html">
            ...
            <DropdownMenu {...makeMenuOptions("Help")}>
              <li><a rel="noopener noreferrer" href="https://www.openapis.org" target="_blank">Open API Initiative (OAI)</a></li>
			  <li><a rel="noopener noreferrer" href="https://github.com/OAI/OpenAPI-Specification" target="_blank">Open API Specs</a></li>
			</DropdownMenu>
			<Link href={this.navigatetoAPI}>Navigate to API list</Link>
          </div>
        </div>
      </div>
    )
